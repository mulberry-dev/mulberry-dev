export const projectsDetails = [
    ...
    }, */
  {
    ...
    name: "Mi Blog",
    description:
      "Blog developed in Next.js, with admin panel where you can add or delete your posts, it has a login and authentication. Offline Mode with Local Storage. (2023)",
